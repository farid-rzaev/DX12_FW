...
public:
    ...
    // Use a memcpy or similar method to copy the buffer data to CPU pointer in 
    // the Allocation structure returned from this function.
...
private:
    ...
    struct Page
    {
        ...
        // than the page size or the size of the allocation exceeds the 
