...
bool Sample6::Initialize(const wchar_t* windowTitle, int width, int height, bool vSync)
{
...
bool Sample6::LoadContent()
{
	...
	// [G-Buffer] - Root Signature and PSO
    {
        ...
        CD3DX12_DESCRIPTOR_RANGE1 descriptorRange(D3D12_DESCRIPTOR_RANGE_TYPE_SRV, 3, 0);  // t0 = diffuse, t1 = roughness, t2 = metalness
        // --
        ...
        rootParameters[GbufferRootParams::Textures_GBuffer].InitAsDescriptorTable(1, &descriptorRange, D3D12_SHADER_VISIBILITY_PIXEL);                          // t0, t1, t2 - DESCRIPTOR HEAP see descriptorRange
...
void Sample6::RescaleRenderTargets(float scale)
{
...
void Sample6::OnResize(ResizeEventArgs& e)
{
    Game::OnResize(e);
...
void Sample6::UnloadContent()
{
}

static double g_FPS = 0.0;

void Sample6::OnUpdate()
{
...
void Sample6::RenderDeferred(std::shared_ptr<CommandList> commandList, DirectX::CXMMATRIX viewMatrix, DirectX::CXMMATRIX viewProjectionMatrix)
{
...
void Sample6::OnKeyPressed(KeyEventArgs& e)
{
    Game::OnKeyPressed(e);
...
void Sample6::OnKeyReleased(KeyEventArgs& e)
{
...
void Sample6::OnMouseMoved(MouseMotionEventArgs& e)
{
    Game::OnMouseMoved(e);
...
void Sample6::OnMouseWheel(MouseWheelEventArgs& e)
{
    Game::OnMouseWheel(e);
