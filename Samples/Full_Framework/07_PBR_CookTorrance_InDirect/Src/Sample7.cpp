...
bool Sample7::Initialize(const wchar_t* windowTitle, int width, int height, bool vSync)
{
...
void Sample7::RescaleRenderTargets(float scale)
{
...
void Sample7::OnResize(ResizeEventArgs& e)
{
    Game::OnResize(e);
...
void Sample7::UnloadContent()
{
}

static double g_FPS = 0.0;

void Sample7::OnUpdate()
{
...
void Sample7::OnKeyPressed(KeyEventArgs& e)
{
    Game::OnKeyPressed(e);
...
void Sample7::OnKeyReleased(KeyEventArgs& e)
{
...
void Sample7::OnMouseMoved(MouseMotionEventArgs& e)
{
    Game::OnMouseMoved(e);
...
void Sample7::OnMouseWheel(MouseWheelEventArgs& e)
{
    Game::OnMouseWheel(e);
